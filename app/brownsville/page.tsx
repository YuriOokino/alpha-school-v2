    ...
    <main>
      ...
      <section className="alpha-section">
        <FeatureCard
          ...
          media={
            <iframe
              src={media.video.replace("youtu.be/", "www.youtube.com/embed/")}
              title="Welcome to Alpha Brownsville"
      ...
      <section className="alpha-section">
        <div className="w-full rounded-[var(--radius-lg)] p-[var(--space-xl)] flex flex-col md:flex-row gap-[var(--space-xl)] items-start bg-[var(--color-bg-muted)]">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-3 mb-4">
              <Button variant="outline" className="w-full flex justify-between items-center" href="/admission">
                Admission Guide
              ...
              <Button variant="outline" className="w-full flex justify-between items-center" href="/video-library">
                Video Library
                <span className="ml-2 flex-shrink-0" aria-hidden="true">
                    <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.293 12.793L6.707 14.207L13.414 7.49997L6.707 0.792969L5.293 2.20697L9.586 6.49997H0V8.49997H9.586L5.293 12.793Z" fill="currentColor"/>
