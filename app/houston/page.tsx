...
export default async function HoustonPage() {
  return (
    <main>
      {/* Main Title Section */}
      <MainHeading>
        Alpha School | Private School in Houston
      </MainHeading>
      ...
      <section className="alpha-section">
        ...
        >
          ...
          <p className="mb-8">At Alpha Houston, our revolutionary 2 Hour Learning model combines cutting-edge technology with personalized, one-on-one academic instruction, empowering students to rank in the top 1-2% nationally.</p>
          <p className="mb-8">Afternoons focus on life skills through hands-on workshops, preparing students to thrive beyond academics. With our guides, students receive tailored support to meet their unique potential. At Alpha Houston, we're not just preparing students for tests; we're preparing them for limitless futures.</p>
          <p>Alpha Houston is coming soon! Join our interest list to be the first to know when we open our doors.</p>
        </FeatureCard>
      </section>
      ...
      <section className="alpha-section">
        <div className="scheme-pink w-full rounded-[var(--radius-lg)] p-[var(--space-xl)] flex flex-col md:flex-row gap-[var(--space-xl)] items-start bg-[var(--color-bg-muted)]">
          <div className="flex-1">
            <h2 className="heading-style-h2 mb-4">Houston Campus</h2>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-3 mb-4">
              ...
              <Button variant="outline" className="w-full flex justify-between items-center" href="/downloads/Alpha School Houston Flipbook.pdf" target="_blank">
                View Brochure
                <span className="ml-2 flex-shrink-0" aria-hidden="true">
                  <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 9L11 5.25H8.75V0H7.25V5.25H5L8 9Z" fill="currentColor"/>
