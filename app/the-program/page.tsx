...
export default function TheProgramPage() {
  ...
  return (
    <section className="alpha-section">
      <h1 className="section-headline font-bold mb-6 text-center">Welcome to Alpha: Where Learning Transforms Lives</h1>
      <p className="text-lg text-[#111827] text-center mb-8">At Alpha, we are redefining education with three commitments to families:
      </p>
      ...
      <FeatureCard
        ...
        className="bg-[#0000ED]"
      >
        <h2 className="text-[20px] text-[#B9EDFF] mb-4">
      ...
      <FeatureCard
        ...
        className="bg-[#B9EDFF]"
      >
        <span className="block tagline-primary font-bold uppercase tracking-wide mb-6 text-sm rounded px-3 py-1 w-max">ALPHA SCHOOL | COMMITMENT #1</span>
        <h2 className="text-[2rem] font-extrabold text-[#0000ED] mb-4">Kids Will Love School</h2>
        <p className="text-[#222] mb-4">At Alpha, we believe that when engagement meets high standards, it nurtures a lifelong passion for learning.</p>
        <ul className="list-disc pl-6 text-[#222] space-y-3">
      ...
      <FeatureCard
        ...
        className="bg-[var(--color-maroon)] text-[var(--color-pink)]"
      >
        <span className="block tagline-accent font-bold uppercase tracking-wide mb-6 text-sm rounded px-3 py-1 w-max">ALPHA SCHOOL | COMMITMENT #2</span>
        <h2 className="text-[2rem] font-extrabold text-[var(--color-pink)] mb-4">Learn 2X in 2 Hours</h2>
        <p className="text-white mb-4">Through advanced technologies and mastery-based learning, students at Alpha complete core subjects in just two hours daily.</p>
        <ul className="list-disc pl-6 text-white space-y-3 mb-4">
        ...
        <h3 className="text-white font-bold mb-2">How We Do It:</h3>
        <p className="text-white">Alpha combines adaptive AI for personalized 1:1 learning, mastery-based methods for deep understanding, and time management techniques like Pomodoro to keep students focused and thriving.</p>
      </FeatureCard>
      <div className="my-[var(--space-xl)]" />
      <FeatureCard
      ...
      >
        <span className="block tagline-maroon font-bold uppercase tracking-wide mb-6 text-sm rounded px-3 py-1 w-max">ALPHA SCHOOL | COMMITMENT #3</span>
        <h2 className="text-[2rem] font-extrabold text-[var(--color-maroon)] mb-4">Life Skills for the Future</h2>
        <p className="text-[#222] mb-4">Alpha isn't just about academics. We're preparing students for life by teaching essential, actionable skills.</p>
        <ul className="list-disc pl-6 text-[#222] space-y-3 mb-4">
